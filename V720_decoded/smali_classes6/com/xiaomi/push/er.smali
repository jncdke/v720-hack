...
.method private a(Lcom/xiaomi/push/service/az;Lcom/xiaomi/push/ah;Z)V
    ...
    invoke-direct {v0, v1}, Lcom/xiaomi/push/ev;-><init>(Landroid/content/Context;)V

    if-eqz p3, :cond_0

    sget-object p3, Lcom/xiaomi/push/is;->b:Lcom/xiaomi/push/is;

    invoke-virtual {p3}, Lcom/xiaomi/push/is;->a()I

    move-result p3

    const v1, 0x15180

    invoke-virtual {p1, p3, v1}, Lcom/xiaomi/push/service/az;->a(II)I

    move-result p1

    invoke-static {p1}, Lcom/xiaomi/push/er;->a(I)I
...
.method private a()Z
    ...
    invoke-direct {v1, v2, v3}, Lcom/xiaomi/push/el;-><init>(Landroid/content/Context;Ljava/lang/String;)V
