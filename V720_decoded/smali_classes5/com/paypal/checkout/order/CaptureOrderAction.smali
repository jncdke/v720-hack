...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "mapError",
        "Lcom/paypal/checkout/order/CaptureOrderResult$Error;",
...
.method private final mapError(Lcom/paypal/checkout/order/UpdateOrderStatusResult$Error;)Lcom/paypal/checkout/order/CaptureOrderResult$Error;
    ...
    const-string v1, "LSAT upgrade failed while capturing order."

    invoke-direct {v0, v3, v1, v2, v3}, Lcom/paypal/checkout/order/CaptureOrderResult$Error;-><init>(Ljava/lang/String;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    const-string v1, "Capture was invoked when the order did not have a valid capture url. This typically happens when capture is called for an authorize order or if capture was invoked prior to the order being approved."
    ...
    .line 46
    new-instance v1, Lcom/paypal/checkout/order/CaptureOrderResult$Error;
    ...
    const-string v5, "Capture order response was not successful. Response status code: "
    ...
    .line 46
    invoke-direct {v1, v3, v0, v2, v3}, Lcom/paypal/checkout/order/CaptureOrderResult$Error;-><init>(Ljava/lang/String;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 54
    invoke-virtual {v0}, Lcom/paypal/checkout/order/CaptureOrderResult$Error;->getMessage()Ljava/lang/String;

    move-result-object v3

    .line 55
    invoke-virtual {v0}, Lcom/paypal/checkout/order/CaptureOrderResult$Error;->getReason()Ljava/lang/String;
...
.method public final execute(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p0, v2}, Lcom/paypal/checkout/order/CaptureOrderAction$execute$2;-><init>(Lcom/paypal/checkout/order/CaptureOrderAction;Lkotlin/coroutines/Continuation;)V
