...
.field protected final f:Lcom/meizu/cloud/pushsdk/platform/c/a;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/meizu/cloud/pushsdk/platform/c/a;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object p5, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->a:Ljava/util/concurrent/ScheduledExecutorService;

    iput-object p1, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->b:Landroid/content/Context;

    iput-object p2, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->c:Ljava/lang/String;

    iput-object p3, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->d:Ljava/lang/String;

    iput-object p4, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->f:Lcom/meizu/cloud/pushsdk/platform/c/a;
...
.method private a(Lcom/meizu/cloud/pushsdk/platform/message/BasicPushStatus;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)Z"
...
.method private k()Z
    ...
    iget-object v1, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->i:Ljava/lang/String;
...
# virtual methods
.method protected abstract a()Lcom/meizu/cloud/pushsdk/platform/message/BasicPushStatus;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TT;"
        }
...
.method protected a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->i:Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->i:Ljava/lang/String;
...
.method public a(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->c:Ljava/lang/String;
...
.method protected abstract b(Lcom/meizu/cloud/pushsdk/platform/message/BasicPushStatus;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)V"
        }
...
.method public b(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->d:Ljava/lang/String;
...
.method protected b()Z
    ...
    invoke-virtual {p0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->j()I
...
.method protected abstract c()Lcom/meizu/cloud/pushsdk/platform/message/BasicPushStatus;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TT;"
        }
...
.method public c(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/meizu/cloud/pushsdk/platform/d/c;->e:Ljava/lang/String;
...
.method public f()Z
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->g()Z
...
.method public g()Z
    ...
    invoke-virtual {p0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->d()Z
    ...
    :goto_0
    invoke-virtual {p0, v0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->b(Lcom/meizu/cloud/pushsdk/platform/message/BasicPushStatus;)V

    goto/16 :goto_4

    :cond_0
    invoke-virtual {p0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->l()Z

    move-result v0

    if-nez v0, :cond_5

    invoke-virtual {p0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->e()Lcom/meizu/cloud/pushsdk/platform/message/BasicPushStatus;
    ...
    invoke-virtual {p0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->b()Z
    ...
    :cond_1
    invoke-direct {p0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->k()Z
    ...
    invoke-direct {p0, v3}, Lcom/meizu/cloud/pushsdk/platform/d/c;->a(I)Z
    ...
    invoke-virtual {p0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->c()Lcom/meizu/cloud/pushsdk/platform/message/BasicPushStatus;
    ...
    :cond_7
    :goto_2
    invoke-virtual {p0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->h()Landroid/content/Intent;

    move-result-object v3

    if-eqz v3, :cond_8

    invoke-virtual {p0, v3}, Lcom/meizu/cloud/pushsdk/platform/d/c;->a(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v6}, Lcom/meizu/cloud/pushsdk/platform/d/c;->a(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v0}, Lcom/meizu/cloud/pushsdk/platform/d/c;->a(Lcom/meizu/cloud/pushsdk/platform/message/BasicPushStatus;)Z
...
.method protected l()Z
    ...
    invoke-virtual {p0, v0, v1}, Lcom/meizu/cloud/pushsdk/platform/d/c;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
