.class public Lcom/naxclow/media/player/IjkMediaMeta;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;
    }
.end annotation
...
# instance fields
.field public mAudioStream:Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;
...
.field public mVideoStream:Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/naxclow/media/player/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;

    return-void
.end method

.method public static parse(Landroid/os/Bundle;)Lcom/naxclow/media/player/IjkMediaMeta;
    .locals 11
    ...
    .line 197
    :cond_0
    new-instance v0, Lcom/naxclow/media/player/IjkMediaMeta;

    invoke-direct {v0}, Lcom/naxclow/media/player/IjkMediaMeta;-><init>()V

    .line 198
    iput-object p0, v0, Lcom/naxclow/media/player/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;

    .line 200
    const-string p0, "format"

    invoke-virtual {v0, p0}, Lcom/naxclow/media/player/IjkMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    iput-object p0, v0, Lcom/naxclow/media/player/IjkMediaMeta;->mFormat:Ljava/lang/String;

    .line 201
    const-string p0, "duration_us"

    invoke-virtual {v0, p0}, Lcom/naxclow/media/player/IjkMediaMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v1

    iput-wide v1, v0, Lcom/naxclow/media/player/IjkMediaMeta;->mDurationUS:J
    ...
    iput-wide v1, v0, Lcom/naxclow/media/player/IjkMediaMeta;->mStartUS:J
    ...
    iput-wide v1, v0, Lcom/naxclow/media/player/IjkMediaMeta;->mBitrate:J
    ...
    invoke-virtual {v0, v1, v2}, Lcom/naxclow/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v4, v2}, Lcom/naxclow/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v6, v2}, Lcom/naxclow/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I

    .line 209
    const-string v6, "streams"

    .line 210
    invoke-virtual {v0, v6}, Lcom/naxclow/media/player/IjkMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 222
    :cond_2
    new-instance v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;

    invoke-direct {v8, v2}, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;-><init>(I)V

    .line 223
    iput-object v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mMeta:Landroid/os/Bundle;

    .line 224
    const-string v7, "type"

    invoke-virtual {v8, v7}, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mLanguage:Ljava/lang/String;

    .line 226
    iget-object v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecName:Ljava/lang/String;
    ...
    iput-object v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecProfile:Ljava/lang/String;
    ...
    iput-object v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecLongName:Ljava/lang/String;

    .line 234
    invoke-virtual {v8, p0}, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v7

    int-to-long v9, v7

    iput-wide v9, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mBitrate:J
    ...
    invoke-virtual {v8, v7}, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v7

    iput v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mWidth:I
    ...
    iput v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mHeight:I
    ...
    iput v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsNum:I
    ...
    iput v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsDen:I
    ...
    iput v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrNum:I
    ...
    iput v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrDen:I
    ...
    iput v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mSarNum:I
    ...
    iput v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mSarDen:I

    if-ne v3, v2, :cond_5

    .line 247
    iput-object v8, v0, Lcom/naxclow/media/player/IjkMediaMeta;->mVideoStream:Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;
    ...
    iput v7, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mSampleRate:I

    .line 252
    const-string v7, "channel_layout"

    .line 253
    invoke-virtual {v8, v7}, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v9

    iput-wide v9, v8, Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;->mChannelLayout:J

    if-ne v5, v2, :cond_5

    .line 256
    iput-object v8, v0, Lcom/naxclow/media/player/IjkMediaMeta;->mAudioStream:Lcom/naxclow/media/player/IjkMediaMeta$IjkStreamMeta;

    .line 259
    :cond_5
    :goto_1
    iget-object v7, v0, Lcom/naxclow/media/player/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;
...
.method public getDurationInline()Ljava/lang/String;
    ...
    .line 184
    iget-wide v0, p0, Lcom/naxclow/media/player/IjkMediaMeta;->mDurationUS:J
...
.method public getInt(Ljava/lang/String;)I
    ...
    .line 148
    invoke-virtual {p0, p1, v0}, Lcom/naxclow/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
...
.method public getInt(Ljava/lang/String;I)I
    ...
    .line 152
    invoke-virtual {p0, p1}, Lcom/naxclow/media/player/IjkMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getLong(Ljava/lang/String;)J
    ...
    .line 164
    invoke-virtual {p0, p1, v0, v1}, Lcom/naxclow/media/player/IjkMediaMeta;->getLong(Ljava/lang/String;J)J
...
.method public getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 180
    iget-object v0, p0, Lcom/naxclow/media/player/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;
