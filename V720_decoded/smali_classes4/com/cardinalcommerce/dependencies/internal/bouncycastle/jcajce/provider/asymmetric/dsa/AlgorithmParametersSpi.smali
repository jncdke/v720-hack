...
# instance fields
.field private getInstance:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineGetEncoded()[B
    ...
    new-instance v0, Lcom/cardinalcommerce/a/DSASigner$detDSA256;

    iget-object v1, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->getInstance:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v1}, Ljava/security/spec/DSAParameterSpec;->getP()Ljava/math/BigInteger;

    move-result-object v1

    iget-object v2, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->getInstance:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v2}, Ljava/security/spec/DSAParameterSpec;->getQ()Ljava/math/BigInteger;

    move-result-object v2

    iget-object v3, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->getInstance:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v3}, Ljava/security/spec/DSAParameterSpec;->getG()Ljava/math/BigInteger;

    move-result-object v3

    invoke-direct {v0, v1, v2, v3}, Lcom/cardinalcommerce/a/DSASigner$detDSA256;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method protected engineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    :cond_1
    :goto_0
    iget-object p1, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->getInstance:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->getInstance:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineInit([B)V
    ...
    .line 4000
    iget-object v2, v1, Lcom/cardinalcommerce/a/DSASigner$detDSA256;->Cardinal:Lcom/cardinalcommerce/a/setEnvironment;
    ...
    .line 6000
    iget-object v2, v1, Lcom/cardinalcommerce/a/DSASigner$detDSA256;->configure:Lcom/cardinalcommerce/a/setEnvironment;
    ...
    .line 8000
    iget-object v1, v1, Lcom/cardinalcommerce/a/DSASigner$detDSA256;->getInstance:Lcom/cardinalcommerce/a/setEnvironment;
