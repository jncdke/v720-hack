...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->getEciFlag:Lcom/cardinalcommerce/a/IESCipher$ECIESwithAESCBC;

    new-instance v0, Lcom/cardinalcommerce/a/ISOSignatureSpi$SHA512_256WithRSAEncryption;

    invoke-direct {v0}, Lcom/cardinalcommerce/a/ISOSignatureSpi$SHA512_256WithRSAEncryption;-><init>()V

    iput-object v0, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->getEnrolled:Lcom/cardinalcommerce/a/GMSignatureSpi$sha256WithSM2;
...
.method protected engineInitSign(Ljava/security/PrivateKey;)V
    ...
    :cond_0
    invoke-static {p1}, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/util/GOST3410Util;->init(Ljava/security/PrivateKey;)Lcom/cardinalcommerce/a/setCCAImageUri;

    move-result-object p1

    :goto_0
    iget-object v0, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->getEciFlag:Lcom/cardinalcommerce/a/IESCipher$ECIESwithAESCBC;

    invoke-interface {v0}, Lcom/cardinalcommerce/a/IESCipher$ECIESwithAESCBC;->init()V

    iget-object v0, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->setEnabledDiscover:Ljava/security/SecureRandom;

    const/4 v1, 0x1

    if-eqz v0, :cond_1

    iget-object v2, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->getEnrolled:Lcom/cardinalcommerce/a/GMSignatureSpi$sha256WithSM2;

    new-instance v3, Lcom/cardinalcommerce/a/DigestSignatureSpi$RIPEMD128;

    invoke-direct {v3, p1, v0}, Lcom/cardinalcommerce/a/DigestSignatureSpi$RIPEMD128;-><init>(Lcom/cardinalcommerce/a/GMCipherSpi$SM2withRMD;Ljava/security/SecureRandom;)V

    invoke-interface {v2, v1, v3}, Lcom/cardinalcommerce/a/GMSignatureSpi$sha256WithSM2;->cca_continue(ZLcom/cardinalcommerce/a/GMCipherSpi$SM2withRMD;)V

    return-void

    :cond_1
    iget-object v0, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->getEnrolled:Lcom/cardinalcommerce/a/GMSignatureSpi$sha256WithSM2;
...
.method protected engineInitSign(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)V
    ...
    iput-object p2, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->setEnabledDiscover:Ljava/security/SecureRandom;
...
.method protected engineInitVerify(Ljava/security/PublicKey;)V
    ...
    :cond_0
    instance-of v1, p1, Lcom/cardinalcommerce/a/PKCS12BagAttributeCarrierImpl;

    if-eqz v1, :cond_1

    invoke-static {p1}, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/util/GOST3410Util;->configure(Ljava/security/PublicKey;)Lcom/cardinalcommerce/a/setCCAImageUri;
...
.method protected engineSign()[B
    ...
    iget-object v1, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->getEciFlag:Lcom/cardinalcommerce/a/IESCipher$ECIESwithAESCBC;
    ...
    iget-object v4, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->getEnrolled:Lcom/cardinalcommerce/a/GMSignatureSpi$sha256WithSM2;

    invoke-interface {v4, v0}, Lcom/cardinalcommerce/a/GMSignatureSpi$sha256WithSM2;->init([B)[Ljava/math/BigInteger;
...
.method protected engineVerify([B)Z
    ...
    iget-object p1, p0, Lcom/cardinalcommerce/dependencies/internal/bouncycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->getEnrolled:Lcom/cardinalcommerce/a/GMSignatureSpi$sha256WithSM2;
